  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white rounded-2xl p-6 border border-[#E2E8F0] shadow-card">
        <div>
          <h2 className="text-2xl font-bold text-[#0F172A] tracking-wide">Permit Approval Workflows</h2>
          <p className="text-xs text-[#64748B] mt-1">Review incoming road cutting applications, check lock-in road protections, and authorize or reject work schedules.</p>
        </div>
        <button onClick={loadPermitQueue} className="flex items-center gap-1.5 rounded-xl bg-white hover:bg-[#F8FAFC] border border-[#E2E8F0] px-4 py-2.5 text-xs font-bold text-[#64748B] transition duration-200 shrink-0">
