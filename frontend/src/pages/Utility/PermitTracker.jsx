...
const PermitTracker = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#0F766E] border border-[#0D9488] shadow-sm rounded-2xl p-6">
        <div>
          <h2 className="text-xl font-bold text-white tracking-tight">Excavation Permit Tracker</h2>
        ...
        <div className="flex items-center gap-2">
          {selectedPermit && (
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-white border border-white/20 hover:bg-[#F0FDF4] px-4 py-2.5 text-xs font-semibold text-[#0F172A] hover:text-[#0F766E] shadow-sm transition duration-200"
            >
